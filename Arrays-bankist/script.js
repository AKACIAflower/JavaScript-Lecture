...
// // (SLICE) Find last element -> don't mutate the original array
...
// FOREACH -> The continue and break statements do not work in a forEach loop at all
// const movements = [200, 450, -400, 3000, -650, -130, 70, 1300];
...
// currencies.forEach((v, k, m) => {
//   console.log(`${v}, ${k}, ${m}`);
// });

// // Set -> a set doesn't have keys and indexs
// const currenciesUnique = new Set(['USD', 'GBP', 'USD', 'EUR', 'EUR']);
// console.log(currenciesUnique);

// currenciesUnique.forEach((v, k, m) => {
//   console.log(`${k}: ${v}`);
// });
...
// Reduce method => 추가적인 변수생성없이 바로 값을 리턴 가능
// console.log(movements);
...
const js = accounts.find(el => el.username === 'js');
...
// Sort method => mutated original array
// Strings
